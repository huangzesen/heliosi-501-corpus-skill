...
- **PSP↔SO conjunction source-mapping.** SO/PHI HRT enables radial-distance-resolved photospheric boundary conditions for in-situ-anchored source-mapping ([[paper-ervin-2024-slow-alfvenic-source-regions-pfss-psp]] is a candidate consumer when an encounter conjunction exists).
