...
- A theoretical prediction for the residual-energy (E_b − E_v) signature across MHD shocks is derived and validated against interplanetary-shock observations — the post-shock residual energy is systematically magnetically excessive.
- The skill applies to: Theoretical derivation + interplanetary-shock observational validation; statistical comparison.

### When NOT to use it

- Do not apply to collisionless ion-scale shock physics — MHD-scale only.
- Do not infer turbulence cascade direction from single-shock residual-energy step.

### Claim boundary

Theoretical derivation + interplanetary-shock observational validation; statistical comparison.
...
|---|---|---|---|---|
| PSP/SolO/Wind MAG + plasma | L2 | burst/standard | interplanetary shock catalog | SPDF/CDAWeb / SOAR |

### 2.4 Failure modes (skill memory)

- Density calibration affects v_A and σ_r normalisation.
- Shock-frame transformation errors propagate.
...
### Pre-shock vs post-shock residual energy σ_r computation
...
### Statistical comparison to MHD theoretical prediction
...
- **Hypothesis** — Residual-energy step magnitude should correlate with shock Mach number — testable on dual-spacecraft catalog. Related: (no explicit sibling).
- **Gap** — No paper-skill yet computes residual-energy steps on the PSP perihelion shock subset. Related: (no explicit sibling).
...
- Source inventory: `sioulas-reproduction/results/arxiv_papers/more_papers_2020_2026.md Topic 3 §7`
