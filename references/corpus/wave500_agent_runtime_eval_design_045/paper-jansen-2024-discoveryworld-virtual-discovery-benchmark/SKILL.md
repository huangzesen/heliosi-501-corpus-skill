...
domain:
  primary_theme: other
  secondary_themes: ["agent-runtime", "scientific-discovery-virtual-environment-benchmark"]
  missions: []
  regime: []

trigger_keywords:
  - "benchmark"
  - "scientific-discovery-virtual-environment-benchmark"
  - "agent-runtime"
  - "ai-scientist"
  - "positioning"
...
data_products: []
algorithms:
  - name: "Virtual scientific-discovery task suite"
  - name: "Hypothesis-generation + experiment-execution evaluation"
  - name: "Standardized agent-environment interface"

validation_target: null

links:
  doi_url: null
  arxiv_url: "https://arxiv.org/abs/2406.06769"
  ads_url: null
  code_repo: null
  data_repo: null
...
claim_boundary:
  scope: >-
    Bounded to the simulated tasks in the environment; real-world discovery is out of scope by construction.
  out_of_scope:
  - "Do not interpret DiscoveryWorld performance as evidence of real-lab capability."
  - "Do not treat simulated instruments as faithful proxies for mission hardware."

failure_modes:
  - "Simulation fidelity gaps may bias agent training."
  - "Task design choices encode latent priors about 'what discovery looks like'."
...
research_generation_affordances:
  - type: hypothesis
    statement: "A heliophysics analog of DiscoveryWorld can be built from cached PSP/SOAR data + synthetic agent prompts: 'recover this published finding using only data and provided tools'."
  - type: minimal_experiment
    statement: "Wrap the existing peri1_scalogram_dense.pkl + sw-scanner code into a DiscoveryWorld-style task and benchmark whether a fresh agent can recover the cascade-rate enhancement claim."

provenance:
  generated_by: "HelioSI paper-to-skill factory (Claude Opus 4.7) - wave500_agent_runtime_eval_design_045"
  generated_at: "2026-05-18T00:00:00Z"
  source_record: "sioulas-reproduction/results/paper_skill_corpus/wave500_agent_runtime_eval_design_045/manifest.json and sioulas-reproduction/results/agent_runtime_paper_scan_raw.md / agent_runtime_2026_only_synthesis.md (arxiv:2406.06769, doi:n/a)"
  verified_by: null
  verified_at: null
...
# DiscoveryWorld: A Virtual Environment for Developing and Evaluating Automated Scientific Discovery Agents - paper-skill (wave500)
...
- designing a HelioSI benchmark or evaluation that should reflect the scientific-discovery-virtual-environment-benchmark pattern
...
**Claim (narrow form).** DiscoveryWorld is a virtual environment of scientific-discovery tasks (multi-step experimentation, hypothesis generation, instrument use) for benchmarking automated discovery agents.
...
### Method 1: Virtual scientific-discovery task suite
...
### Method 2: Hypothesis-generation + experiment-execution evaluation

- Paper role: explicit named method/component of the paper's contribution.
- Abstract procedure: the runtime that wants to borrow this pattern must be able to (a) instantiate the component as a callable, (b) feed it the manuscript/benchmark/sibling-skill inputs from §4, and (c) emit an artifact a Layer-4 affordance can reference.

### Method 3: Standardized agent-environment interface
...
**In scope.** Bounded to the simulated tasks in the environment; real-world discovery is out of scope by construction.
...
- DOI: n/a
- arXiv: [arXiv:2406.06769](https://arxiv.org/abs/2406.06769)
- ADS: n/a
- Code: n/a
- Data: n/a
...
- **Hypothesis** - A heliophysics analog of DiscoveryWorld can be built from cached PSP/SOAR data + synthetic agent prompts: 'recover this published finding using only data and provided tools'. Related: n/a.
- **Minimal_experiment** - Wrap the existing peri1_scalogram_dense.pkl + sw-scanner code into a DiscoveryWorld-style task and benchmark whether a fresh agent can recover the cascade-rate enhancement claim. Related: n/a.
