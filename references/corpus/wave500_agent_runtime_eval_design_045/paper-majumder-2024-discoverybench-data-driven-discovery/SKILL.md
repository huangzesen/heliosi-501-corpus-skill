...
domain:
  primary_theme: other
  secondary_themes: ["agent-runtime", "scientific-discovery-data-driven-benchmark"]
  missions: []
  regime: []

trigger_keywords:
  - "benchmark"
  - "scientific-discovery-data-driven-benchmark"
  - "agent-runtime"
  - "ai-scientist"
  - "positioning"
...
data_products: []
algorithms:
  - name: "Curated dataset + finding pairs"
  - name: "Hypothesis-propose-test-refine evaluation loop"
  - name: "Recovery-rate scoring"

validation_target: null

links:
  doi_url: null
  arxiv_url: "https://arxiv.org/abs/2407.01725"
  ads_url: null
  code_repo: null
  data_repo: null
...
claim_boundary:
  scope: >-
    Bounded to the curated datasets and findings included in the benchmark; the score is recovery-of-finding, not new discovery.
  out_of_scope:
  - "Do not conflate 'recover known finding' with 'make new discovery'."
  - "Do not generalize task coverage beyond the benchmark's domain mix."

failure_modes:
  - "Recovery score can be gamed by memorization if the underlying papers are in the LLM's training data."
  - "Dataset-finding pairs may include implicit human-curated cues."

depends_on:
  - paper-jansen-2024-discoveryworld-virtual-discovery-benchmark

adapter_notes: []

research_generation_affordances:
  - type: minimal_experiment
    statement: "Convert HelioSI's cached scalograms + benchmark artifacts into a DiscoveryBench-style heliophysics benchmark; score whether agents recover Sioulas et al. findings."
  - type: gap
    statement: "DiscoveryBench has no heliophysics tasks; HelioSI can contribute the first heliophysics task pack."

provenance:
  generated_by: "HelioSI paper-to-skill factory (Claude Opus 4.7) - wave500_agent_runtime_eval_design_045"
  generated_at: "2026-05-18T00:00:00Z"
  source_record: "sioulas-reproduction/results/paper_skill_corpus/wave500_agent_runtime_eval_design_045/manifest.json and sioulas-reproduction/results/agent_runtime_paper_scan_raw.md / agent_runtime_2026_only_synthesis.md (arxiv:2407.01725, doi:n/a)"
  verified_by: null
  verified_at: null
...
# DiscoveryBench: Towards Data-Driven Discovery with Large Language Models - paper-skill (wave500)
...
- designing a HelioSI benchmark or evaluation that should reflect the scientific-discovery-data-driven-benchmark pattern
...
**Claim (narrow form).** DiscoveryBench is a benchmark of data-driven scientific-discovery tasks where an LLM must propose, test, and refine hypotheses against curated datasets, scored on recovery of the published finding.
...
### Method 1: Curated dataset + finding pairs
...
### Method 2: Hypothesis-propose-test-refine evaluation loop

- Paper role: explicit named method/component of the paper's contribution.
- Abstract procedure: the runtime that wants to borrow this pattern must be able to (a) instantiate the component as a callable, (b) feed it the manuscript/benchmark/sibling-skill inputs from §4, and (c) emit an artifact a Layer-4 affordance can reference.

### Method 3: Recovery-rate scoring
...
**In scope.** Bounded to the curated datasets and findings included in the benchmark; the score is recovery-of-finding, not new discovery.
...
- DOI: n/a
- arXiv: [arXiv:2407.01725](https://arxiv.org/abs/2407.01725)
- ADS: n/a
- Code: n/a
- Data: n/a
...
- `[[paper-jansen-2024-discoveryworld-virtual-discovery-benchmark]]` - paper-skill within the same wave500 batch (sibling positioning/design-pattern source).
...
- **Minimal_experiment** - Convert HelioSI's cached scalograms + benchmark artifacts into a DiscoveryBench-style heliophysics benchmark; score whether agents recover Sioulas et al. findings. Related: n/a.
- **Gap** - DiscoveryBench has no heliophysics tasks; HelioSI can contribute the first heliophysics task pack. Related: n/a.
