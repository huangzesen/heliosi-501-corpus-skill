...
paper:
  ...
  first_author: "Xie, Q."
  authors: ["Qiujie Xie", "Yixuan Weng", "Minjun Zhu", "Fuchen Shen", "Shulin Huang", "Zhen Lin"]
  year: 2025
...
data_products: []
algorithms:
  - name: "Prospect-driven survey methodology"
  - name: "Capability-gap taxonomy"
  - name: "Conditions for human-level discovery"

validation_target: null

links:
  doi_url: null
  arxiv_url: "https://arxiv.org/abs/2507.23276"
  ads_url: null
  code_repo: null
  data_repo: null
...
claim_boundary:
  scope: >-
    Survey; claims about 'how far' are qualitative landscape calls, not benchmark results.
  out_of_scope:
  - "Do not treat survey landscape conclusions as benchmark facts."
  - "Do not cite 'X system is close to world-changing' from this paper."

failure_modes:
  - "Forecast statements age quickly."
  - "Field coverage may be biased toward CS/ML systems."

depends_on:
  - paper-wei-2025-agentic-science-survey-autonomous-discovery

adapter_notes: []

research_generation_affordances:
  - type: gap
    statement: "The survey's capability-gap list lacks a 'domain-grounded executable skill memory' axis; HelioSI's corpus fills it for heliophysics."
  - type: hypothesis
    statement: "Using the survey's capability gaps as a HelioSI manuscript checklist will surface at least one HelioSI weakness (e.g. lack of preregistration), useful as honest limitation."

provenance:
  generated_by: "HelioSI paper-to-skill factory (Claude Opus 4.7) - wave500_agent_runtime_eval_design_045"
  generated_at: "2026-05-18T00:00:00Z"
  source_record: "sioulas-reproduction/results/paper_skill_corpus/wave500_agent_runtime_eval_design_045/manifest.json and sioulas-reproduction/results/agent_runtime_paper_scan_raw.md / agent_runtime_2026_only_synthesis.md (arxiv:2507.23276, doi:n/a)"
  verified_by: null
  verified_at: null
...
# How Far Are AI Scientists from Changing the World? - paper-skill (wave500)
...
**Claim (narrow form).** A prospect-driven review of AI Scientist systems argues the field is closer to narrow-replication than to world-changing discovery; the survey lists capability gaps and the conditions under which human-level discovery may become feasible.
...
### Method 1: Prospect-driven survey methodology
...
### Method 2: Capability-gap taxonomy

- Paper role: explicit named method/component of the paper's contribution.
- Abstract procedure: the runtime that wants to borrow this pattern must be able to (a) instantiate the component as a callable, (b) feed it the manuscript/benchmark/sibling-skill inputs from §4, and (c) emit an artifact a Layer-4 affordance can reference.

### Method 3: Conditions for human-level discovery
...
**In scope.** Survey; claims about 'how far' are qualitative landscape calls, not benchmark results.
...
- DOI: n/a
- arXiv: [arXiv:2507.23276](https://arxiv.org/abs/2507.23276)
- ADS: n/a
- Code: n/a
- Data: n/a
...
- `[[paper-wei-2025-agentic-science-survey-autonomous-discovery]]` - paper-skill within the same wave500 batch (sibling positioning/design-pattern source).
...
- **Gap** - The survey's capability-gap list lacks a 'domain-grounded executable skill memory' axis; HelioSI's corpus fills it for heliophysics. Related: n/a.
- **Hypothesis** - Using the survey's capability gaps as a HelioSI manuscript checklist will surface at least one HelioSI weakness (e.g. lack of preregistration), useful as honest limitation. Related: n/a.
