...
data_products: []
algorithms:
  - name: "Perception-brain-action taxonomy"
  - name: "Agent topology + construction patterns"
  - name: "Evaluation suite catalog"

validation_target: null

links:
  doi_url: null
  arxiv_url: "https://arxiv.org/abs/2309.07864"
  ads_url: null
  code_repo: null
  data_repo: null
...
claim_boundary:
  scope: >-
    Survey; claim is taxonomic, not empirical.
  out_of_scope:
  - "Do not cite for any single architecture's performance."
  - "Do not assume the 'general AI step' claim is universally accepted."

failure_modes:
  - "Survey ages quickly."
  - "Taxonomy may not match recent runtime designs."
...
research_generation_affordances:
  - type: minimal_experiment
    statement: "Use the survey's perception-brain-action labels to annotate HelioSI's architecture diagram; emit a structured comparison table for the manuscript."

provenance:
  generated_by: "HelioSI paper-to-skill factory (Claude Opus 4.7) - wave500_agent_runtime_eval_design_045"
  generated_at: "2026-05-18T00:00:00Z"
  source_record: "sioulas-reproduction/results/paper_skill_corpus/wave500_agent_runtime_eval_design_045/manifest.json and sioulas-reproduction/results/agent_runtime_paper_scan_raw.md / agent_runtime_2026_only_synthesis.md (arxiv:2309.07864, doi:n/a)"
  verified_by: null
  verified_at: null
...
# The Rise and Potential of Large Language Model Based Agents: A Survey - paper-skill (wave500)
...
**Claim (narrow form).** Survey of LLM-based agents covering perception, brain, action; agent construction patterns; single + multi-agent topologies; evaluation. Argues LLM agents are a pivotal step toward general AI.
...
### Method 1: Perception-brain-action taxonomy
...
### Method 2: Agent topology + construction patterns

- Paper role: explicit named method/component of the paper's contribution.
- Abstract procedure: the runtime that wants to borrow this pattern must be able to (a) instantiate the component as a callable, (b) feed it the manuscript/benchmark/sibling-skill inputs from §4, and (c) emit an artifact a Layer-4 affordance can reference.

### Method 3: Evaluation suite catalog
...
**In scope.** Survey; claim is taxonomic, not empirical.
...
- DOI: n/a
- arXiv: [arXiv:2309.07864](https://arxiv.org/abs/2309.07864)
- ADS: n/a
- Code: n/a
- Data: n/a
...
- **Minimal_experiment** - Use the survey's perception-brain-action labels to annotate HelioSI's architecture diagram; emit a structured comparison table for the manuscript. Related: n/a.
