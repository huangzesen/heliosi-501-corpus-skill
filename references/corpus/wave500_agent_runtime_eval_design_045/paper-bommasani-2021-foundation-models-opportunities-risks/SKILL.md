...
domain:
  primary_theme: other
  secondary_themes: ["agent-runtime", "domain-knowledge-compilation-position"]
  missions: []
  regime: []

trigger_keywords:
  - "survey"
  - "domain-knowledge-compilation-position"
  - "agent-runtime"
  - "ai-scientist"
  - "positioning"
...
data_products: []
algorithms:
  - name: "Conceptual taxonomy of capabilities + risks"
  - name: "Cross-domain application survey"
  - name: "Discussion of homogenization + emergence"

validation_target: null

links:
  doi_url: null
  arxiv_url: "https://arxiv.org/abs/2108.07258"
  ads_url: null
  code_repo: null
  data_repo: null
...
claim_boundary:
  scope: >-
    A survey/position essay; claims are conceptual landscape calls, not empirical.
  out_of_scope:
  - "Do not cite as evidence of any specific model's capabilities."
  - "Do not treat 'foundation model' as a universally-defined object."

failure_modes:
  - "Position essays age fast."
  - "Risk taxonomy may not match domain-specific risk surfaces."
...
research_generation_affordances:
  - type: hypothesis
    statement: "Foundation-model risk taxonomy applies to HelioSI: homogenization risk if every heliophysics analysis routes through the same agent; accountability risk if Layer-2 contracts are not auditable. The HelioSI manuscript's limitations section should cite this."
  - type: gap
    statement: "Heliophysics-specific foundation models (Surya / SuryaBench) are emerging; HelioSI should explicitly differentiate paper-skill graph from foundation model substrate."

provenance:
  generated_by: "HelioSI paper-to-skill factory (Claude Opus 4.7) - wave500_agent_runtime_eval_design_045"
  generated_at: "2026-05-18T00:00:00Z"
  source_record: "sioulas-reproduction/results/paper_skill_corpus/wave500_agent_runtime_eval_design_045/manifest.json and sioulas-reproduction/results/agent_runtime_paper_scan_raw.md / agent_runtime_2026_only_synthesis.md (arxiv:2108.07258, doi:n/a)"
  verified_by: null
  verified_at: null
...
# On the Opportunities and Risks of Foundation Models - paper-skill (wave500)
...
- designing a HelioSI benchmark or evaluation that should reflect the domain-knowledge-compilation-position pattern
...
**Claim (narrow form).** Foundation models constitute a paradigm shift: a single model trained at scale becomes the substrate for many downstream tasks; opportunities + risks must be analyzed together (emergent capabilities, homogenization, accountability, deployment risks).
...
### Method 1: Conceptual taxonomy of capabilities + risks
...
### Method 2: Cross-domain application survey

- Paper role: explicit named method/component of the paper's contribution.
- Abstract procedure: the runtime that wants to borrow this pattern must be able to (a) instantiate the component as a callable, (b) feed it the manuscript/benchmark/sibling-skill inputs from §4, and (c) emit an artifact a Layer-4 affordance can reference.

### Method 3: Discussion of homogenization + emergence
...
**In scope.** A survey/position essay; claims are conceptual landscape calls, not empirical.
...
- DOI: n/a
- arXiv: [arXiv:2108.07258](https://arxiv.org/abs/2108.07258)
- ADS: n/a
- Code: n/a
- Data: n/a
...
- **Hypothesis** - Foundation-model risk taxonomy applies to HelioSI: homogenization risk if every heliophysics analysis routes through the same agent; accountability risk if Layer-2 contracts are not auditable. The HelioSI manuscript's limitations section should cite this. Related: n/a.
- **Gap** - Heliophysics-specific foundation models (Surya / SuryaBench) are emerging; HelioSI should explicitly differentiate paper-skill graph from foundation model substrate. Related: n/a.
