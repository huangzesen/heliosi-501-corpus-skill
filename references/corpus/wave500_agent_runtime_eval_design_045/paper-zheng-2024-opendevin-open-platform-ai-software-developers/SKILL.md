...
domain:
  primary_theme: other
  secondary_themes: ["agent-runtime", "agent-runtime-open-platform-agent-engineering"]
  missions: []
  regime: []

trigger_keywords:
  - "agent-system"
  - "agent-runtime-open-platform-agent-engineering"
  - "agent-runtime"
  - "ai-scientist"
  - "positioning"
...
data_products: []
algorithms:
  - name: "Sandboxed runtime (Docker-based)"
  - name: "Browser + terminal + file tool integration"
  - name: "Multi-agent orchestration"
  - name: "SWE-bench-style evaluation harness"
...
claim_boundary:
  scope: >-
    Bounded to software-engineering agents; evaluation is on coding/web benchmarks.
  out_of_scope:
  - "Do not assume the sandbox + tool stack maps unchanged to scientific data archives."
  - "Do not interpret 'generalist' as 'cross-domain'."

failure_modes:
  - "Sandbox-host friction; reproducibility depends on container images."
  - "Tool failure modes propagate silently without explicit assertions."

depends_on:
  - paper-yang-2024-swe-agent-language-model-software-engineer

adapter_notes: []

research_generation_affordances:
  - type: hypothesis
    statement: "OpenDevin's sandboxed-runtime + multi-agent pattern is the harness-level analogue of what HelioSI needs for cross-runtime portability. The paper-skill corpus is the science-content equivalent of OpenDevin's tool catalog."
  - type: minimal_experiment
    statement: "Stand up a minimal OpenDevin sandbox with sunpy + pfsspy + pyspedas pre-installed, point it at one HelioSI paper-skill, and confirm a Layer-2 capability completes inside the container."

provenance:
  generated_by: "HelioSI paper-to-skill factory (Claude Opus 4.7) - wave500_agent_runtime_eval_design_045"
  generated_at: "2026-05-18T00:00:00Z"
  source_record: "sioulas-reproduction/results/paper_skill_corpus/wave500_agent_runtime_eval_design_045/manifest.json and sioulas-reproduction/results/agent_runtime_paper_scan_raw.md / agent_runtime_2026_only_synthesis.md (arxiv:2407.16741, doi:n/a)"
  verified_by: null
  verified_at: null
...
# OpenDevin: An Open Platform for AI Software Developers as Generalist Agents - paper-skill (wave500)
...
- designing a HelioSI benchmark or evaluation that should reflect the agent-runtime-open-platform-agent-engineering pattern
...
**Claim (narrow form).** OpenDevin (now OpenHands) is an open-source platform for generalist software-engineering agents: sandboxed runtime, browser + terminal + file tools, multi-agent orchestration, evaluation on SWE-bench-style tasks.
...
### Method 1: Sandboxed runtime (Docker-based)
...
### Method 2: Browser + terminal + file tool integration
...
### Method 4: SWE-bench-style evaluation harness
...
**In scope.** Bounded to software-engineering agents; evaluation is on coding/web benchmarks.
...
- DOI: n/a
- arXiv: [arXiv:2407.16741](https://arxiv.org/abs/2407.16741)
- ADS: n/a
- Code: n/a
- Data: n/a
...
- `[[paper-yang-2024-swe-agent-language-model-software-engineer]]` - paper-skill within the same wave500 batch (sibling positioning/design-pattern source).
...
- **Hypothesis** - OpenDevin's sandboxed-runtime + multi-agent pattern is the harness-level analogue of what HelioSI needs for cross-runtime portability. The paper-skill corpus is the science-content equivalent of OpenDevin's tool catalog. Related: n/a.
- **Minimal_experiment** - Stand up a minimal OpenDevin sandbox with sunpy + pfsspy + pyspedas pre-installed, point it at one HelioSI paper-skill, and confirm a Layer-2 capability completes inside the container. Related: n/a.
