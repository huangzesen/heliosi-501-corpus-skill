...
paper:
  ...
  first_author: "Zhu, M."
  authors: ["Minjun Zhu", "Qiujie Xie", "Yixuan Weng", "Jian Wu", "Zhen Lin", "Linyi Yang"]
  year: 2025
...
domain:
  primary_theme: other
  secondary_themes: ["agent-runtime", "agent-runtime-critique-implementation"]
  missions: []
  regime: []

trigger_keywords:
  - "critique"
  - "agent-runtime-critique-implementation"
  - "agent-runtime"
  - "ai-scientist"
  - "positioning"
...
data_products: []
algorithms:
  - name: "Quantitative scoring of AI-Scientist outputs across writing vs. implementation axes"
  - name: "Identification of implementation-capability gaps"
  - name: "Recommendation set for closing the gaps"

validation_target: null

links:
  doi_url: null
  arxiv_url: "https://arxiv.org/abs/2506.01372"
  ads_url: null
  code_repo: null
  data_repo: null
...
claim_boundary:
  scope: >-
    Quantitative analysis restricted to computer-science papers and code artifacts; natural-science generalization is asserted, not proven.
  out_of_scope:
  - "Do not over-extrapolate to natural-science domains without separate evidence."
  - "Do not interpret 'failure' as inability — the paper claims under-performance, not absolute failure."

failure_modes:
  - "Score-axis design itself can be biased toward implementation; counter-evidence requires alternative axes."
  - "Population of evaluated systems is small."

depends_on:
  - paper-lu-2024-ai-scientist-fully-automated-discovery
  - paper-yamada-2025-ai-scientist-v2-agentic-tree-search

adapter_notes: []

research_generation_affordances:
  - type: hypothesis
    statement: "HelioSI's 'paper-skill corpus + executable contracts + benchmark artifacts' design directly addresses the implementation gap this paper diagnoses; the HelioSI manuscript should cite it as one of the diagnoses HelioSI answers."
  - type: minimal_experiment
    statement: "Add an implementation-rigor score to HelioSI's benchmark report (fraction of skills with passing contract, fraction with reproducible figure) and compare against the AI-Scientist v2 baseline reported in the critique."

provenance:
  generated_by: "HelioSI paper-to-skill factory (Claude Opus 4.7) - wave500_agent_runtime_eval_design_045"
  generated_at: "2026-05-18T00:00:00Z"
  source_record: "sioulas-reproduction/results/paper_skill_corpus/wave500_agent_runtime_eval_design_045/manifest.json and sioulas-reproduction/results/agent_runtime_paper_scan_raw.md / agent_runtime_2026_only_synthesis.md (arxiv:2506.01372, doi:n/a)"
  verified_by: null
  verified_at: null
...
# AI Scientists Fail Without Strong Implementation Capability - paper-skill (wave500)
...
- drafting/revising HelioSI manuscript sections that compare against critique systems
- designing a HelioSI benchmark or evaluation that should reflect the agent-runtime-critique-implementation pattern
...
**Claim (narrow form).** Quantitative evidence shows that current AI Scientist systems' headline outputs are dominated by writing/idea-quality scores rather than implementation rigor; without strong code-execution and experiment-implementation capability, AI Scientists fail to deliver groundbreaking computer-science discoveries.
...
### Method 1: Quantitative scoring of AI-Scientist outputs across writing vs. implementation axes
...
### Method 2: Identification of implementation-capability gaps

- Paper role: explicit named method/component of the paper's contribution.
- Abstract procedure: the runtime that wants to borrow this pattern must be able to (a) instantiate the component as a callable, (b) feed it the manuscript/benchmark/sibling-skill inputs from §4, and (c) emit an artifact a Layer-4 affordance can reference.

### Method 3: Recommendation set for closing the gaps
...
**In scope.** Quantitative analysis restricted to computer-science papers and code artifacts; natural-science generalization is asserted, not proven.
...
- DOI: n/a
- arXiv: [arXiv:2506.01372](https://arxiv.org/abs/2506.01372)
- ADS: n/a
- Code: n/a
- Data: n/a
...
- `[[paper-yamada-2025-ai-scientist-v2-agentic-tree-search]]` - paper-skill within the same wave500 batch (sibling positioning/design-pattern source).
...
- **Hypothesis** - HelioSI's 'paper-skill corpus + executable contracts + benchmark artifacts' design directly addresses the implementation gap this paper diagnoses; the HelioSI manuscript should cite it as one of the diagnoses HelioSI answers. Related: n/a.
- **Minimal_experiment** - Add an implementation-rigor score to HelioSI's benchmark report (fraction of skills with passing contract, fraction with reproducible figure) and compare against the AI-Scientist v2 baseline reported in the critique. Related: n/a.
