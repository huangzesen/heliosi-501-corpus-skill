...
data_products: []
algorithms:
  - name: "Community review of ML adoption barriers"
  - name: "Modeler-aware design recommendations"
  - name: "Physics + ML integration patterns"
...
claim_boundary:
  scope: >-
    Bounded to ML adoption in heliophysics + space-weather modeling; not a benchmark result.
  out_of_scope:
  - "Do not propagate specific identifiers without verifying full text."
  - "Do not interpret as evidence of any single ML technique's superiority."

failure_modes:
  - "Community reviews date quickly given fast ML evolution."
  - "Recommendations are qualitative; need concrete benchmarks to enforce."
...
research_generation_affordances:
  - type: hypothesis
    statement: "HelioSI's paper-skill failure_modes + claim_boundary fields operationalize the modeler-aware design principles this review advocates: every ML or pipeline skill carries explicit caveats."
  - type: minimal_experiment
    statement: "Audit the existing 11 ML/segmentation paper-skills (batch_solar_wind_segmentation_ml) against the review's design principles; report compliance + gaps."

provenance:
  generated_by: "HelioSI paper-to-skill factory (Claude Opus 4.7) - wave500_agent_runtime_eval_design_045"
  generated_at: "2026-05-18T00:00:00Z"
  source_record: "sioulas-reproduction/results/paper_skill_corpus/wave500_agent_runtime_eval_design_045/manifest.json and sioulas-reproduction/results/agent_runtime_paper_scan_raw.md / agent_runtime_2026_only_synthesis.md (arxiv:n/a, doi:n/a)"
  verified_by: null
  verified_at: null
...
# Machine Learning in Heliophysics and Space Weather Forecasting: A Modeler's Perspective - paper-skill (wave500)
...
**Claim (narrow form).** Machine-learning adoption in heliophysics + space-weather forecasting requires modeler-aware design: data quality + provenance, mission-specific instrument calibration awareness, interpretability, and integration with physics models. [TODO_verify_with_full_text — claim summary based on community reviews; full DOI/identifier pending.]
...
### Method 1: Community review of ML adoption barriers
...
### Method 2: Modeler-aware design recommendations

- Paper role: explicit named method/component of the paper's contribution.
- Abstract procedure: the runtime that wants to borrow this pattern must be able to (a) instantiate the component as a callable, (b) feed it the manuscript/benchmark/sibling-skill inputs from §4, and (c) emit an artifact a Layer-4 affordance can reference.

### Method 3: Physics + ML integration patterns
...
**In scope.** Bounded to ML adoption in heliophysics + space-weather modeling; not a benchmark result.
...
- **Hypothesis** - HelioSI's paper-skill failure_modes + claim_boundary fields operationalize the modeler-aware design principles this review advocates: every ML or pipeline skill carries explicit caveats. Related: n/a.
- **Minimal_experiment** - Audit the existing 11 ML/segmentation paper-skills (batch_solar_wind_segmentation_ml) against the review's design principles; report compliance + gaps. Related: n/a.
