...
domain:
  primary_theme: other
  secondary_themes: ["agent-runtime", "agent-runtime-multi-agent-survey"]
  missions: []
  regime: []

trigger_keywords:
  - "survey"
  - "agent-runtime-multi-agent-survey"
  - "agent-runtime"
  - "ai-scientist"
  - "positioning"
...
data_products: []
algorithms:
  - name: "Domain/environment simulation taxonomy"
  - name: "Agent profile + communication mechanism survey"
  - name: "Capacity-growth + benchmark catalog"

validation_target: null

links:
  doi_url: null
  arxiv_url: "https://arxiv.org/abs/2402.01680"
  ads_url: null
  code_repo: null
  data_repo: null
...
claim_boundary:
  scope: >-
    Coverage survey; claims are about taxonomy + landscape, not empirical results.
  out_of_scope:
  - "Do not cite the survey as evidence for a specific architecture's performance."
  - "Do not assume the taxonomy is exhaustive given the 2024 cutoff."

failure_modes:
  - "Survey ages quickly."
  - "Field coverage skewed to NLP/RL multi-agent work."
...
research_generation_affordances:
  - type: minimal_experiment
    statement: "Use the survey's profiling/communication taxonomy to label HelioSI agents (literature, data, PFSS, turbulence, benchmark, writing) and emit a manuscript-ready architecture table."

provenance:
  generated_by: "HelioSI paper-to-skill factory (Claude Opus 4.7) - wave500_agent_runtime_eval_design_045"
  generated_at: "2026-05-18T00:00:00Z"
  source_record: "sioulas-reproduction/results/paper_skill_corpus/wave500_agent_runtime_eval_design_045/manifest.json and sioulas-reproduction/results/agent_runtime_paper_scan_raw.md / agent_runtime_2026_only_synthesis.md (arxiv:2402.01680, doi:n/a)"
  verified_by: null
  verified_at: null
...
# Large Language Model based Multi-Agents: A Survey of Progress and Challenges - paper-skill (wave500)
...
- designing a HelioSI benchmark or evaluation that should reflect the agent-runtime-multi-agent-survey pattern
...
**Claim (narrow form).** Survey of LLM-based multi-agent systems covering domains/environments simulated, agent profiling + communication, capacity-growth mechanisms, datasets/benchmarks, with an open-source companion repo for tracking ongoing work.
...
### Method 1: Domain/environment simulation taxonomy
...
### Method 2: Agent profile + communication mechanism survey

- Paper role: explicit named method/component of the paper's contribution.
- Abstract procedure: the runtime that wants to borrow this pattern must be able to (a) instantiate the component as a callable, (b) feed it the manuscript/benchmark/sibling-skill inputs from §4, and (c) emit an artifact a Layer-4 affordance can reference.

### Method 3: Capacity-growth + benchmark catalog
...
**In scope.** Coverage survey; claims are about taxonomy + landscape, not empirical results.
...
- DOI: n/a
- arXiv: [arXiv:2402.01680](https://arxiv.org/abs/2402.01680)
- ADS: n/a
- Code: n/a
- Data: n/a
...
- **Minimal_experiment** - Use the survey's profiling/communication taxonomy to label HelioSI agents (literature, data, PFSS, turbulence, benchmark, writing) and emit a manuscript-ready architecture table. Related: n/a.
