...
domain:
  primary_theme: other
  secondary_themes: ["agent-runtime", "heliophysics-machine-learning-design-review"]
  missions: []
  regime: []

trigger_keywords:
  - "heliophysics-evaluation-design"
  - "heliophysics-machine-learning-design-review"
  - "agent-runtime"
  - "ai-scientist"
  - "positioning"
...
data_products: []
algorithms:
  - name: "Method taxonomy (regression, classification, deep learning)"
  - name: "Challenge enumeration (imbalance, interpretability, data quality, operations)"
  - name: "Community evaluation framework proposal"

validation_target: null

links:
  doi_url: "https://doi.org/10.1029/2018SW002061"
  arxiv_url: null
  ads_url: null
  code_repo: null
  data_repo: null
...
claim_boundary:
  scope: >-
    Bounded to space-weather nowcasting/forecasting at the 2019 horizon; the four challenges are taxonomic.
  out_of_scope:
  - "Do not over-cite for any specific method's accuracy."
  - "Do not assume the 2019 taxonomy is exhaustive for 2026 problems."

failure_modes:
  - "Taxonomy ages; new methods (transformers, foundation models) not covered."
  - "Operational constraints are mission-specific."
...
research_generation_affordances:
  - type: hypothesis
    statement: "HelioSI's benchmark design should explicitly score on the 4 challenges Camporeale enumerates; class-imbalance specifically maps to rare-event paper-skills like ICME / SEP / switchback detection."
  - type: minimal_experiment
    statement: "Add per-skill labels for the 4 Camporeale challenges in the ML / segmentation batch; emit a coverage table identifying under-served challenges."

provenance:
  generated_by: "HelioSI paper-to-skill factory (Claude Opus 4.7) - wave500_agent_runtime_eval_design_045"
  generated_at: "2026-05-18T00:00:00Z"
  source_record: "sioulas-reproduction/results/paper_skill_corpus/wave500_agent_runtime_eval_design_045/manifest.json and sioulas-reproduction/results/agent_runtime_paper_scan_raw.md / agent_runtime_2026_only_synthesis.md (arxiv:n/a, doi:10.1029/2018SW002061)"
  verified_by: null
  verified_at: null
...
# The Challenge of Machine Learning in Space Weather: Nowcasting and Forecasting - paper-skill (wave500)
...
- drafting/revising HelioSI manuscript sections that compare against heliophysics-evaluation-design systems
- designing a HelioSI benchmark or evaluation that should reflect the heliophysics-machine-learning-design-review pattern
...
**Claim (narrow form).** Space-weather ML applications must address: (1) class imbalance (rare events), (2) physical interpretability, (3) data quality + heterogeneity, (4) operational constraints. Reviews ML methods (regression, classification, deep learning) and proposes a community evaluation framework. [TODO_verify_with_full_text on exact framework details.]
...
### Method 1: Method taxonomy (regression, classification, deep learning)
...
### Method 2: Challenge enumeration (imbalance, interpretability, data quality, operations)

- Paper role: explicit named method/component of the paper's contribution.
- Abstract procedure: the runtime that wants to borrow this pattern must be able to (a) instantiate the component as a callable, (b) feed it the manuscript/benchmark/sibling-skill inputs from §4, and (c) emit an artifact a Layer-4 affordance can reference.

### Method 3: Community evaluation framework proposal
...
**In scope.** Bounded to space-weather nowcasting/forecasting at the 2019 horizon; the four challenges are taxonomic.
...
- DOI: [10.1029/2018SW002061](https://doi.org/10.1029/2018SW002061)
- arXiv: n/a
- ADS: n/a
- Code: n/a
- Data: n/a
...
- **Hypothesis** - HelioSI's benchmark design should explicitly score on the 4 challenges Camporeale enumerates; class-imbalance specifically maps to rare-event paper-skills like ICME / SEP / switchback detection. Related: n/a.
- **Minimal_experiment** - Add per-skill labels for the 4 Camporeale challenges in the ML / segmentation batch; emit a coverage table identifying under-served challenges. Related: n/a.
