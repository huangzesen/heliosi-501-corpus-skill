...
name: paper-bran-2024-chemcrow-augmenting-llms-chemistry-tools
description: >-
  Use when the agent is positioning the consuming agent/manuscript against ai-scientist-system literature, borrowing a agent-runtime-domain-tools design pattern, or auditing a benchmark/manuscript claim related to it - central claim is "Integrating 18 expert-designed chemistry tools with a GPT-4 LLM yields new emergent capabilities (autonomous planning + execution of organic syntheses, novel ch" (Nature Machine Intelligence 2024).
version: 0.1.0
kind: paper-skill
...
paper:
  title: "Augmenting large language models with chemistry tools (ChemCrow)"
  first_author: "Bran, A. M."
...
data_products: []
algorithms:
  - name: "Curated expert tool library (18 chemistry tools)"
  - name: "GPT-4 as central reasoning driver"
  - name: "Plan -> tool-call -> verify loop"
  - name: "Expert + LLM hybrid evaluation"

validation_target: null

links:
  doi_url: "https://doi.org/10.1038/s42256-024-00832-8"
  arxiv_url: "https://arxiv.org/abs/2304.05376"
  ads_url: null
  code_repo: null
  data_repo: null
...
claim_boundary:
  scope: >-
    Bounded to the 18-tool harness, GPT-4 driver, and the paper's expert-assessment panel; chemistry-domain only.
  out_of_scope:
  - "Do not treat 'emergent capability' as a universal claim of the tool-augmentation pattern across domains."
  - "Do not assume the same 18 tools transfer to heliophysics."

failure_modes:
  - "Tool-curation cost is high and rarely surfaced; transferring the pattern requires the same expert investment per domain."
  - "Expert assessment is qualitative; scale-out to other expert panels not guaranteed."
...
research_generation_affordances:
  - type: hypothesis
    statement: "HelioSI's 'paper-skill + MCP' design is the heliophysics analogue of the ChemCrow '18 expert tools' design. The HelioSI corpus is the long-tail tool library; mission MCPs are the short list of integration adapters."
  - type: minimal_experiment
    statement: "Pick 18 heliophysics skill/MCP capabilities (PFSS, PVI, structure-function, kappa-fit, CDAWeb fetch, etc.) and benchmark whether a ChemCrow-style plan-call-verify loop solves a paper-grounded question on PSP."

provenance:
  generated_by: "HelioSI paper-to-skill factory (Claude Opus 4.7) - wave500_agent_runtime_eval_design_045"
  generated_at: "2026-05-18T00:00:00Z"
  source_record: "sioulas-reproduction/results/paper_skill_corpus/wave500_agent_runtime_eval_design_045/manifest.json and sioulas-reproduction/results/agent_runtime_paper_scan_raw.md / agent_runtime_2026_only_synthesis.md (arxiv:2304.05376, doi:10.1038/s42256-024-00832-8)"
  verified_by: null
  verified_at: null
...
# Augmenting large language models with chemistry tools (ChemCrow) - paper-skill (wave500)
...
**Claim (narrow form).** Integrating 18 expert-designed chemistry tools with a GPT-4 LLM yields new emergent capabilities (autonomous planning + execution of organic syntheses, novel chromophore discovery guidance), validated via LLM-as-judge and expert assessment.
...
### Method 1: Curated expert tool library (18 chemistry tools)
...
### Method 2: GPT-4 as central reasoning driver

- Paper role: explicit named method/component of the paper's contribution.
- Abstract procedure: the runtime that wants to borrow this pattern must be able to (a) instantiate the component as a callable, (b) feed it the manuscript/benchmark/sibling-skill inputs from §4, and (c) emit an artifact a Layer-4 affordance can reference.

### Method 3: Plan -> tool-call -> verify loop

- Paper role: explicit named method/component of the paper's contribution.
- Abstract procedure: the runtime that wants to borrow this pattern must be able to (a) instantiate the component as a callable, (b) feed it the manuscript/benchmark/sibling-skill inputs from §4, and (c) emit an artifact a Layer-4 affordance can reference.

### Method 4: Expert + LLM hybrid evaluation
...
**In scope.** Bounded to the 18-tool harness, GPT-4 driver, and the paper's expert-assessment panel; chemistry-domain only.
...
- arXiv: [arXiv:2304.05376](https://arxiv.org/abs/2304.05376)
- ADS: n/a
- Code: n/a
- Data: n/a
...
- **Hypothesis** - HelioSI's 'paper-skill + MCP' design is the heliophysics analogue of the ChemCrow '18 expert tools' design. The HelioSI corpus is the long-tail tool library; mission MCPs are the short list of integration adapters. Related: n/a.
- **Minimal_experiment** - Pick 18 heliophysics skill/MCP capabilities (PFSS, PVI, structure-function, kappa-fit, CDAWeb fetch, etc.) and benchmark whether a ChemCrow-style plan-call-verify loop solves a paper-grounded question on PSP. Related: n/a.
