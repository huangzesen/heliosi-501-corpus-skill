...
description: >-
  Use when the agent is positioning HelioSI against ai-scientist-system literature, borrowing a agent-runtime-domain-tools design pattern, or auditing a benchmark/manuscript claim related to it - central claim is "Integrating 18 expert-designed chemistry tools with a GPT-4 LLM yields new emergent capabilities (autonomous planning + execution of organic syntheses, novel ch" (Nature Machine Intelligence 2024).
version: 0.1.0
kind: paper-skill
