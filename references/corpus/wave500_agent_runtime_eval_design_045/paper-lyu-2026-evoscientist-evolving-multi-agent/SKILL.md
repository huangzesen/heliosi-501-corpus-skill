...
description: >-
  Use when the agent is positioning HelioSI against ai-scientist-system literature, borrowing a agent-runtime-persistent-memory-evolution design pattern, or auditing a benchmark/manuscript claim related to it - central claim is "EvoScientist replaces static AI-scientist pipelines with an evolving multi-agent system that improves research strategies through persistent memory and self-evo" (arXiv preprint 2026).
version: 0.1.0
kind: paper-skill
