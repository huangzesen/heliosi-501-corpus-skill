---
name: paper-katsavrias-2025-pds-catalog-mesoscale-mlready-dataset
description: >-
  Use when consuming the Katsavrias 2025 periodic-density-structure catalog as an ML-ready training/evaluation set for mesoscale-structure detection — central paper claim is
  The Katsavrias PDS catalog supplies a publicly released ML-ready mesoscale-structure dataset on Solar Orbiter 0.3–1 au data (TODO verify 2025).
version: 0.1.0
kind: paper-skill
quality: stub
...
domain:
  ...
  secondary_themes: ["dataset", "mesoscale-structures", "ml-ready", "catalog"]
  missions: ["SolO"]
  regime: []  # TODO verify (sub-Alfvenic | super-Alfvenic | inner-heliosphere | 1au | corona | ...)
trigger_keywords: ["periodic-density-structures", "mesoscale", "catalog", "ml-ready", "solar-orbiter", "dataset"]
...
links:
  doi_url: null
  arxiv_url: "https://arxiv.org/abs/2511.15518"
  ads_url: null
  code_repo: null
  data_repo: null
claim_boundary:
  scope: >-
    Stub: The Katsavrias PDS catalog supplies a publicly released ML-ready mesoscale-structure dataset on Solar Orbiter 0.3–1 au data. The narrow scope (mission, distance range, wind type, time-window) is TODO verify against the primary source. At stub tier this skill is referenced by slug and listed in the wave-level index; do not inherit the headline numbers as benchmarked claims.
  out_of_scope:
...
depends_on: ["paper-katsavrias-2025-periodic-density-structures-solar-orbiter"]
adapter_notes: []
research_generation_affordances:
  - type: gap
    statement: "Stub skill — methods, data contracts, and validation target not yet compiled from the primary source."
    related_skills: ["paper-katsavrias-2025-periodic-density-structures-solar-orbiter"]
...
# Katsavrias 2025 PDS catalog as an ML-ready mesoscale-structure dataset — paper-skill (stub)

> Compiled from C. Katsavrias (2025), "Katsavrias 2025 PDS catalog as an ML-ready mesoscale-structure dataset", TODO verify, arXiv:2511.15518.
...
- Consuming the Katsavrias 2025 periodic-density-structure catalog as an ML-ready training/evaluation set for mesoscale-structure detection.
...
**Claim (narrow form).** The Katsavrias PDS catalog supplies a publicly released ML-ready mesoscale-structure dataset on Solar Orbiter 0.3–1 au data. The narrow form below should be tightened once the full text is verified:
...
**In scope.** Stub: The Katsavrias PDS catalog supplies a publicly released ML-ready mesoscale-structure dataset on Solar Orbiter 0.3–1 au data. The narrow scope (mission, distance range, wind type, time-window) is TODO verify against the primary source. At stub tier this skill is referenced by slug and listed in the wave-level index; do not inherit the headline numbers as benchmarked claims.
...
- `[[paper-katsavrias-2025-periodic-density-structures-solar-orbiter]]` — sibling slug; relation TODO verify in full text.

**Research-generation affordances.** Forward-pointing surface of the skill (spec §4 Layer 4):

- **Gap** — Stub skill; the executable protocol (Layer 2) is not yet compiled. Related: `[[paper-katsavrias-2025-periodic-density-structures-solar-orbiter]]`. Proposed: promote to method-ready by populating §3/§4/§5 from the primary source.
...
Dataset-side companion to the parent PDS-catalog skill; release URL and license TODO verify.
