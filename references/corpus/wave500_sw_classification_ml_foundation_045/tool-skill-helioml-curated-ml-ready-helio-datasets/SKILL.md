---
name: tool-skill-helioml-curated-ml-ready-helio-datasets
description: >-
  Use when locating curated ML-ready heliophysics datasets / notebooks for prototyping new models — central paper claim is
  HelioML curates an open, executable catalog of heliophysics ML-ready notebooks across multiple missions (TODO verify (book / online resource) 2019).
version: 0.1.0
kind: tool-skill
quality: stub
...
domain:
  ...
  secondary_themes: ["dataset", "ml-ready", "curated", "infrastructure"]
  missions: ["multi-mission"]
  regime: []  # TODO verify (sub-Alfvenic | super-Alfvenic | inner-heliosphere | 1au | corona | ...)
trigger_keywords: ["helioml", "dataset", "notebooks", "ml-ready", "infrastructure", "curated-catalog"]
...
- Locating curated ML-ready heliophysics datasets / notebooks for prototyping new models.
...
**Claim (narrow form).** HelioML curates an open, executable catalog of heliophysics ML-ready notebooks across multiple missions. The narrow form below should be tightened once the full text is verified:
...
**In scope.** Stub: HelioML curates an open, executable catalog of heliophysics ML-ready notebooks across multiple missions. The narrow scope (mission, distance range, wind type, time-window) is TODO verify against the primary source. At stub tier this skill is referenced by slug and listed in the wave-level index; do not inherit the headline numbers as benchmarked claims.
...
Tool-skill anchor; canonical URL / latest version TODO verify before any consumer integration.
