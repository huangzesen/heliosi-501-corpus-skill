---
name: paper-orbiter-fno-spherical-surrogate
description: >-
  Use when training a spherical Fourier neural operator as a global solar-wind surrogate — central paper claim is
  A spherical FNO surrogate reproduces global solar-wind structure at a fraction of MHD simulation cost (TODO verify 2025).
version: 0.1.0
kind: paper-skill
quality: stub
...
domain:
  ...
  secondary_themes: ["machine-learning", "neural-operator", "surrogate", "solar-wind-simulation"]
  missions: ["SDO", "OMNI"]
  regime: []  # TODO verify (sub-Alfvenic | super-Alfvenic | inner-heliosphere | 1au | corona | ...)
trigger_keywords: ["fourier-neural-operator", "spherical-fno", "surrogate", "solar-wind", "global", "ml-physics"]
...
links:
  doi_url: null
  arxiv_url: "https://arxiv.org/abs/2511.22112"
  ads_url: null
  code_repo: null
  data_repo: null
claim_boundary:
  scope: >-
    Stub: A spherical FNO surrogate reproduces global solar-wind structure at a fraction of MHD simulation cost. The narrow scope (mission, distance range, wind type, time-window) is TODO verify against the primary source. At stub tier this skill is referenced by slug and listed in the wave-level index; do not inherit the headline numbers as benchmarked claims.
  out_of_scope:
...
- Training a spherical Fourier neural operator as a global solar-wind surrogate.
...
**Claim (narrow form).** A spherical FNO surrogate reproduces global solar-wind structure at a fraction of MHD simulation cost. The narrow form below should be tightened once the full text is verified:
...
- arXiv: https://arxiv.org/abs/2511.22112
...
Stub built from theme_solar_wind_segmentation.json entry arxiv_id=2511.22112. Author list and exact training dataset / benchmark MAE TODO verify in the full paper.
