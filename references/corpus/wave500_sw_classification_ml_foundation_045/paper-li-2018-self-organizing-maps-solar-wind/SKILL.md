---
name: paper-li-2018-self-organizing-maps-solar-wind
description: >-
  Use when running SOM clustering on multi-feature 1-au solar-wind vectors to discover regimes — central paper claim is
  SOM clustering recovers 4–6 solar-wind regimes consistent with physical labelling traditions (TODO verify 2018).
version: 0.1.0
kind: paper-skill
quality: stub
...
domain:
  ...
  secondary_themes: ["machine-learning", "unsupervised-classification", "self-organizing-map"]
  missions: ["ACE", "Wind"]
  regime: []  # TODO verify (sub-Alfvenic | super-Alfvenic | inner-heliosphere | 1au | corona | ...)
trigger_keywords: ["solar-wind", "classification", "self-organizing-map", "unsupervised", "clustering", "1au"]
...
claim_boundary:
  scope: >-
    Stub: SOM clustering recovers 4–6 solar-wind regimes consistent with physical labelling traditions. The narrow scope (mission, distance range, wind type, time-window) is TODO verify against the primary source. At stub tier this skill is referenced by slug and listed in the wave-level index; do not inherit the headline numbers as benchmarked claims.
  out_of_scope:
...
# Self-organizing-map clustering of 1-au solar-wind regimes — paper-skill (stub)

> Compiled from TODO verify (Li / SOM lineage) (2018), "Self-organizing-map clustering of 1-au solar-wind regimes", TODO verify, TODO verify arXiv ID.
...
- Running SOM clustering on multi-feature 1-au solar-wind vectors to discover regimes.
...
**Claim (narrow form).** SOM clustering recovers 4–6 solar-wind regimes consistent with physical labelling traditions. The narrow form below should be tightened once the full text is verified:
...
**In scope.** Stub: SOM clustering recovers 4–6 solar-wind regimes consistent with physical labelling traditions. The narrow scope (mission, distance range, wind type, time-window) is TODO verify against the primary source. At stub tier this skill is referenced by slug and listed in the wave-level index; do not inherit the headline numbers as benchmarked claims.
...
Stub anchor for SOM lineage; primary author and venue TODO verify.
