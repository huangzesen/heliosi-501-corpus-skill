---
name: paper-helio-scientific-llm-agent-discovery
description: >-
  Use when evaluating LLM-driven agentic systems on heliophysics scientific discovery tasks — central paper claim is
  LLM-driven agents can scaffold heliophysics ML pipelines and propose hypotheses but currently fall short of autonomous discovery (TODO verify 2025).
version: 0.1.0
kind: paper-skill
quality: stub
...
paper:
  title: "Large-language-model agentic discovery system for heliophysics tasks"
  first_author: "TODO verify (helio-LLM-agent lineage)"
...
domain:
  ...
  secondary_themes: ["llm-agent", "scientific-discovery", "automation", "infrastructure"]
  missions: ["multi-mission"]
  regime: []  # TODO verify (sub-Alfvenic | super-Alfvenic | inner-heliosphere | 1au | corona | ...)
trigger_keywords: ["llm-agent", "scientific-discovery", "automation", "helio-ai", "agentic"]
...
claim_boundary:
  scope: >-
    Stub: LLM-driven agents can scaffold heliophysics ML pipelines and propose hypotheses but currently fall short of autonomous discovery. The narrow scope (mission, distance range, wind type, time-window) is TODO verify against the primary source. At stub tier this skill is referenced by slug and listed in the wave-level index; do not inherit the headline numbers as benchmarked claims.
  out_of_scope:
...
depends_on: ["agentic-ai-scientists-not-built-autonomous-discovery-2026"]
adapter_notes: []
research_generation_affordances:
  - type: gap
    statement: "Stub skill — methods, data contracts, and validation target not yet compiled from the primary source."
    related_skills: ["agentic-ai-scientists-not-built-autonomous-discovery-2026"]
...
- Evaluating LLM-driven agentic systems on heliophysics scientific discovery tasks.
...
**Claim (narrow form).** LLM-driven agents can scaffold heliophysics ML pipelines and propose hypotheses but currently fall short of autonomous discovery. The narrow form below should be tightened once the full text is verified:
...
**In scope.** Stub: LLM-driven agents can scaffold heliophysics ML pipelines and propose hypotheses but currently fall short of autonomous discovery. The narrow scope (mission, distance range, wind type, time-window) is TODO verify against the primary source. At stub tier this skill is referenced by slug and listed in the wave-level index; do not inherit the headline numbers as benchmarked claims.
...
- `[[agentic-ai-scientists-not-built-autonomous-discovery-2026]]` — sibling slug; relation TODO verify in full text.

**Research-generation affordances.** Forward-pointing surface of the skill (spec §4 Layer 4):

- **Gap** — Stub skill; the executable protocol (Layer 2) is not yet compiled. Related: `[[agentic-ai-scientists-not-built-autonomous-discovery-2026]]`. Proposed: promote to method-ready by populating §3/§4/§5 from the primary source.
...
Stub anchor; bibliographic identifiers TODO verify.
