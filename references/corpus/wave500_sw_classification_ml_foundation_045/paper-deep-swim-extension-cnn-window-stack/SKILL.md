---
name: paper-deep-swim-extension-cnn-window-stack
description: >-
  Use when extending the Deep-SWIM 5-min stacked-B-component CNN window pipeline to longer windows / additional missions — central paper claim is
  A window-stacked CNN extension of Deep-SWIM retains binary discontinuity classification skill on longer windows / new missions (TODO verify 2023).
version: 0.1.0
kind: paper-skill
quality: stub
...
domain:
  ...
  secondary_themes: ["machine-learning", "cnn", "discontinuities", "few-shot"]
  missions: ["Wind", "ACE"]
  regime: []  # TODO verify (sub-Alfvenic | super-Alfvenic | inner-heliosphere | 1au | corona | ...)
trigger_keywords: ["deep-swim", "cnn", "discontinuities", "few-shot", "window-stack", "solar-wind", "classification"]
...
claim_boundary:
  scope: >-
    Stub: A window-stacked CNN extension of Deep-SWIM retains binary discontinuity classification skill on longer windows / new missions. The narrow scope (mission, distance range, wind type, time-window) is TODO verify against the primary source. At stub tier this skill is referenced by slug and listed in the wave-level index; do not inherit the headline numbers as benchmarked claims.
  out_of_scope:
...
depends_on: ["paper-hu-2022-deep-swim-cnn-discontinuities"]
adapter_notes: []
research_generation_affordances:
  - type: gap
    statement: "Stub skill — methods, data contracts, and validation target not yet compiled from the primary source."
    related_skills: ["paper-hu-2022-deep-swim-cnn-discontinuities"]
...
# Window-stacked CNN extension of Deep-SWIM for solar-wind magnetic-discontinuity — paper-skill (stub)

> Compiled from TODO verify (Hu / Deep-SWIM successor) (2023), "Window-stacked CNN extension of Deep-SWIM for solar-wind magnetic-discontinuity classification", TODO verify, TODO verify arXiv ID.
...
- Extending the Deep-SWIM 5-min stacked-B-component CNN window pipeline to longer windows / additional missions.
...
**Claim (narrow form).** A window-stacked CNN extension of Deep-SWIM retains binary discontinuity classification skill on longer windows / new missions. The narrow form below should be tightened once the full text is verified:
...
- `[[paper-hu-2022-deep-swim-cnn-discontinuities]]` — sibling slug; relation TODO verify in full text.

**Research-generation affordances.** Forward-pointing surface of the skill (spec §4 Layer 4):

- **Gap** — Stub skill; the executable protocol (Layer 2) is not yet compiled. Related: `[[paper-hu-2022-deep-swim-cnn-discontinuities]]`. Proposed: promote to method-ready by populating §3/§4/§5 from the primary source.
...
Hypothetical extension; bibliographic anchor TODO verify before any promotion past stub.
