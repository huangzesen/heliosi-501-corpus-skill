---
name: paper-multimodal-encoder-decoder-l1-solar-wind-forecast
description: >-
  Use when forecasting L1 solar-wind speed with a multi-modal encoder–decoder ingesting SDO imagery and L1 in-situ history — central paper claim is
  A multi-modal encoder–decoder beats persistence and single-modality baselines on multi-day L1 solar-wind speed forecasts (TODO verify 2025).
version: 0.1.0
kind: paper-skill
quality: stub
...
domain:
  ...
  secondary_themes: ["machine-learning", "encoder-decoder", "forecast", "multi-modal", "l1"]
  missions: ["ACE", "DSCOVR", "SDO"]
  regime: []  # TODO verify (sub-Alfvenic | super-Alfvenic | inner-heliosphere | 1au | corona | ...)
trigger_keywords: ["encoder-decoder", "multi-modal", "solar-wind-speed", "forecast", "l1", "ml-forecasting"]
...
links:
  doi_url: null
  arxiv_url: "https://arxiv.org/abs/2507.17298"
  ads_url: null
  code_repo: null
  data_repo: null
claim_boundary:
  scope: >-
    Stub: A multi-modal encoder–decoder beats persistence and single-modality baselines on multi-day L1 solar-wind speed forecasts. The narrow scope (mission, distance range, wind type, time-window) is TODO verify against the primary source. At stub tier this skill is referenced by slug and listed in the wave-level index; do not inherit the headline numbers as benchmarked claims.
  out_of_scope:
...
depends_on: ["paper-roy-2025-surya-finetune-solar-wind-speed-forecast"]
adapter_notes: []
research_generation_affordances:
  - type: gap
    statement: "Stub skill — methods, data contracts, and validation target not yet compiled from the primary source."
    related_skills: ["paper-roy-2025-surya-finetune-solar-wind-speed-forecast"]
...
- Forecasting L1 solar-wind speed with a multi-modal encoder–decoder ingesting SDO imagery and L1 in-situ history.
...
**Claim (narrow form).** A multi-modal encoder–decoder beats persistence and single-modality baselines on multi-day L1 solar-wind speed forecasts. The narrow form below should be tightened once the full text is verified:
...
- arXiv: https://arxiv.org/abs/2507.17298
...
- `[[paper-roy-2025-surya-finetune-solar-wind-speed-forecast]]` — sibling slug; relation TODO verify in full text.

**Research-generation affordances.** Forward-pointing surface of the skill (spec §4 Layer 4):

- **Gap** — Stub skill; the executable protocol (Layer 2) is not yet compiled. Related: `[[paper-roy-2025-surya-finetune-solar-wind-speed-forecast]]`. Proposed: promote to method-ready by populating §3/§4/§5 from the primary source.
...
Stub built from extended_search.md §6.6. Author list, exact MAE/RMSE and horizon TODO verify.
