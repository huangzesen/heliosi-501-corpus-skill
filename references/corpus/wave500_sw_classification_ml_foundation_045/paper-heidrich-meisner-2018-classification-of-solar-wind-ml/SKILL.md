---
name: paper-heidrich-meisner-2018-classification-of-solar-wind-ml
description: >-
  Use when comparing early-deep-learning baselines on 1-au solar-wind regime classification — central paper claim is
  An early supervised-ML baseline at 1 au sets a reference accuracy for the 4-class scheme (TODO verify (arXiv:1505.02563 lineage) 2018).
version: 0.1.0
kind: paper-skill
quality: stub
...
domain:
  ...
  secondary_themes: ["machine-learning", "supervised-classification", "early-deep-learning"]
  missions: ["ACE"]
  regime: []  # TODO verify (sub-Alfvenic | super-Alfvenic | inner-heliosphere | 1au | corona | ...)
trigger_keywords: ["solar-wind", "classification", "early-ml", "1au", "ace", "supervised", "baseline"]
...
# Early-deep-learning classification of solar-wind regimes (1505.02563 mirror line — paper-skill (stub)

> Compiled from V. Heidrich-Meisner (TODO verify) (2018), "Early-deep-learning classification of solar-wind regimes (1505.02563 mirror lineage)", TODO verify (arXiv:1505.02563 lineage), arXiv:1505.02563.
...
- Comparing early-deep-learning baselines on 1-au solar-wind regime classification.
...
**Claim (narrow form).** An early supervised-ML baseline at 1 au sets a reference accuracy for the 4-class scheme. The narrow form below should be tightened once the full text is verified:
...
**In scope.** Stub: An early supervised-ML baseline at 1 au sets a reference accuracy for the 4-class scheme. The narrow scope (mission, distance range, wind type, time-window) is TODO verify against the primary source. At stub tier this skill is referenced by slug and listed in the wave-level index; do not inherit the headline numbers as benchmarked claims.
...
Stub built from the extended_search.md §6.5/§6.10 mirrors; primary author and venue TODO verify against arXiv:1505.02563.
