...
description: >-
  Use when extending a 1-au supervised classifier across multi-mission L1+L4+L5 archives — central paper claim is
  A supervised classifier trained on one mission generalises across Wind/ACE/STEREO with class-balanced accuracy ≥ TODO verify (TODO verify 2020).
version: 0.1.0
kind: paper-skill
quality: stub
...
domain:
  ...
  secondary_themes: ["machine-learning", "supervised-classification", "multi-mission"]
  missions: ["Wind", "ACE", "STEREO"]
  regime: []  # TODO verify (sub-Alfvenic | super-Alfvenic | inner-heliosphere | 1au | corona | ...)
trigger_keywords: ["solar-wind", "classification", "supervised", "wind", "ace", "stereo", "multi-mission"]
...
claim_boundary:
  scope: >-
    Stub: A supervised classifier trained on one mission generalises across Wind/ACE/STEREO with class-balanced accuracy ≥ TODO verify. The narrow scope (mission, distance range, wind type, time-window) is TODO verify against the primary source. At stub tier this skill is referenced by slug and listed in the wave-level index; do not inherit the headline numbers as benchmarked claims.
  out_of_scope:
...
# Multi-mission extension of supervised solar-wind classification (Wind + ACE + ST — paper-skill (stub)

> Compiled from TODO verify (Li et al.) (2020), "Multi-mission extension of supervised solar-wind classification (Wind + ACE + STEREO)", TODO verify, TODO verify arXiv ID.
...
- Extending a 1-au supervised classifier across multi-mission L1+L4+L5 archives.
...
**Claim (narrow form).** A supervised classifier trained on one mission generalises across Wind/ACE/STEREO with class-balanced accuracy ≥ TODO verify. The narrow form below should be tightened once the full text is verified:
...
Hypothetical anchor for the multi-mission extension of the Xu–Borovsky tradition; exact author / venue / arXiv ID TODO verify before any promotion past stub.
