---
name: paper-wijsen-2024-cross-field-diffusion-coronal-flux-rope
description: >-
  Use when cross-field diffusion or related diagnostics surface in a SEP / shock / space-weather workflow — central claim: Cross-field diffusion inside a coronal flux rope produces a measurable spread of energetic-particle distributions across field lines, with implications for ICME magnetic-cloud particle observations. (arXiv:2411.00738, 2024).
version: 0.1.0
kind: paper-skill
quality: stub
...
paper:
  ...
  first_author: "Wijsen, N. (TODO verify)"
  authors:
    - "TODO verify"
  year: 2024
...
trigger_keywords:
  ...
  - "coronal flux rope"
  - "energetic-particle transport in flux rope"
  - "ICME magnetic cloud diffusion"

data_products: []  # theory / modeling-only

algorithms:
  - name: "Flux-rope-geometry test-particle / Fokker-Planck solver"
    equation_refs: []
    external_implementations: []
  - name: "Cross-field diffusion coefficient parametrization"
    equation_refs: []
    external_implementations: []
  - name: "Comparison of intensity-vs-time across field lines"
    equation_refs: []
    external_implementations: []
...
links:
  doi_url: null
  arxiv_url: "https://arxiv.org/abs/2411.00738"
  ads_url: null
  code_repo: null
  data_repo: null
...
claim_boundary:
  scope: >-
    Simulation study (TODO_verify code); flux-rope geometry; energetic-particle injection scenarios.
  out_of_scope:
    - "Do not use the simulation results as a stand-alone prediction for in-situ observations."

failure_modes:
  - "Cross-field diffusion model is highly parameter-dependent"
  - "Test-particle vs full-PIC differences"
...
research_generation_affordances:
  - type: "gap"
    statement: "No event-specific ICME flux-rope simulation matched to PSP/SOLO observations."
    related_skills: []
  - type: "minimal_experiment"
    statement: "Couple the simulation to the 2024-05-11 ICME flux rope; predict cross-cloud intensity profile."
    related_skills: []

provenance:
  generated_by: "HelioSI paper-to-skill factory (Claude Opus 4.7) — wave500 SEP/shocks/space-weather batch"
  generated_at: "2026-05-18T00:00:00Z"
  source_record: "sioulas-reproduction/results/arxiv_papers/theme_energetic_particles.json#arxiv:2411.00738"
  verified_by: null
  verified_at: null
...
# Cross-Field Diffusion Effects on Particle Transport in a Solar Coronal Flux Rope — paper-skill

> Compiled from arXiv:2411.00738 (2024), Wijsen, N. (TODO verify) et al.
...
**Claim (narrow form).** Cross-field diffusion inside a coronal flux rope produces a measurable spread of energetic-particle distributions across field lines, with implications for ICME magnetic-cloud particle observations.

**Verifiable task.** A reproduction succeeds when an agent reads the
abstract capability contract in §3–§4 and reproduces Cross-field spread vs κ_perp / κ_par scaling (TODO_verify numerics). within
...
### Flux-rope-geometry test-particle / Fokker-Planck solver

- Procedure (abstract, runtime-neutral):
  1. TODO_verify_with_full_text — paraphrased from inventory abstract only.
- Capability requirements:
  - Flux-rope-geometry test-particle / Fokker-Planck solver as a callable on the data products in §4.

### Cross-field diffusion coefficient parametrization

- Procedure (abstract, runtime-neutral):
  1. TODO_verify_with_full_text — paraphrased from inventory abstract only.
- Capability requirements:
  - Cross-field diffusion coefficient parametrization as a callable on the data products in §4.

### Comparison of intensity-vs-time across field lines

- Procedure (abstract, runtime-neutral):
  1. TODO_verify_with_full_text — paraphrased from inventory abstract only.
- Capability requirements:
  - Comparison of intensity-vs-time across field lines as a callable on the data products in §4.
...
reference. The target is: Cross-field spread vs κ_perp / κ_par scaling (TODO_verify numerics).
...
**In scope.** Simulation study (TODO_verify code); flux-rope geometry; energetic-particle injection scenarios.
...
- arXiv: https://arxiv.org/abs/2411.00738
...
- **Gap** — No event-specific ICME flux-rope simulation matched to PSP/SOLO observations.
- **Minimal_experiment** — Couple the simulation to the 2024-05-11 ICME flux rope; predict cross-cloud intensity profile.
